...
void PinYuLuBoDib::QuickFourier()
{
	...
	double temp;//中间变量
	CNumber *t,*f;
	p_data=GetData();//指向原图象数据区

	width=GetWidth();//得到图象宽度
	height=GetHeight();//得到图象高度
    long lLineBytes=GetLineByte();//计算图象每行的字节数
...
//////////////////////////////////////////////////////////////
//该函数用来实现二维傅立叶变换
//参数height、width分别表示图象的高度和宽度，ising表示正反变换(-1：正变换，1：反变换)
//////////////////////////////////////////////////////////////
